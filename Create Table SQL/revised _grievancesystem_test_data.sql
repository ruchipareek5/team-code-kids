...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2019 at 01:59 PM
...
INSERT INTO `table_message` (`id`, `grievance_id`, `committee_member`, `principal`, `ombudsman`, `aicte`, `created_at`, `read_status`) VALUES
(1, 1, 'Message of committee', 'Message from principal', 'Message from ombudsman', 'Message from AICTE', '2019-02-22 12:04:51', NULL);
